...
const SOCIAL_LINKS = [
  ...
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/bibek-shrestha-b95a422aa/',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: 'Email',
    url: 'mailto:bibek.srestha20@gmail.com',
    icon: (
      ...
      <div className="footer-container">
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <p className="footer-tagline">Building digital experiences with precision and passion.</p>
          </div>
