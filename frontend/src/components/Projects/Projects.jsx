...
const PROJECTS = [
  ...
  },
  {
    ...
    github: 'https://github.com/biibekk/air-traffic-controller-simulation',
  },
  {
    ...
    github: 'https://github.com/biibekk/Rainfall-Prediction-Delhi-NCR-ML',
  },
    {
                ...
                <div className="project-links">
                  ...
                  {proj.live && proj.live !== '#' && (
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="project-link live-icon" 
